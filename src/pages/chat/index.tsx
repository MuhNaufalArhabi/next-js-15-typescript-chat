...
export default function Home() {
  ...
  return (
    <>
      <div className="flex justify-end gap-2 items-center w-full px-4 py-2">
        <h1 className="font-bold">{userName}</h1>
        <button className="bg-red-400 text-white px-2 py-1 rounded-lg cursor-pointer" onClick={handleSignOut}>
          sign out
        </button>
      </div>
